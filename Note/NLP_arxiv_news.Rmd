...
subtitle: '- word prediction through the Back-off model and Latent Sementic Analysis'
author: "Gavin Wang"
date: "May 2, 2016"
...
The word prediction is based on the Katz's back-off model, which is a count-based method. This interactive webpage [app](https://gavin0wang.shinyapps.io/shinyApp/) is developed by using R package [Shiny](https://cran.r-project.org/web/packages/shiny/index.html). 
<!--
...
## **Section 5 ** : *Latent sementic analysis: term similarity*
...
tdm2_lsa <- lsa(tdm2_tfidf) #Create the latent sementic space
...
By doing the latent sementic analysis, I could recommend possible relavent terms to further broden one's vision. For instance, assume one is familiar with a physics term, *quantum field*, what other terms might he be interested in?
...
*  ### Work I have done
  ...
  2. word/term assiciation by latent sementic analysis
  3. webpage application for word prediction

The analysis I did above is based on count-based methods. The syntactic information is still missing. Thus, direct predictive methods with vector presentation of words from models, such as [The Skip-gram and Continuous Bag-of-Words model](https://www.tensorflow.org/versions/r0.8/tutorials/index.html), is necessary. Fortunately, [Alphabeta Company](https://abc.xyz/) provides an open source software library [tensorflow](https://www.tensorflow.org/), for natural languge processing. There is also an online course, [Deep Learning for Natural Language Processing](http://cs224d.stanford.edu/) provided by stanford university.
